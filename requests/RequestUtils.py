...
class APIException(util.SECIngressException):
    """
    APIException
    """
...
def request(
    url, method, body=None, headers=None, params=None, data=None, rate_limiter=None
):
    """
    ...
    if rate_limiter:
        with rate_limiter:
            response = getattr(requests, method)(
                url, json=body, headers=headers, params=params, data=data
            )
    else:
        response = getattr(requests, method)(
            url, json=body, headers=headers, params=params, data=data
...
def get(url, body=None, headers=None, params=None, data=None, rate_limiter=None):
    """
    Makes a HTTP GET request
    """
    return request(url, "get", body, headers, params, data, rate_limiter)
